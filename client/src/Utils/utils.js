...
export const generateRandomUsers = (count) => {
  const users = [];
  const names = ["Алексей", "Иван", "Петр", "Сергей", "Дмитрий", "Николай", "Михаил", "Андрей", "Владимир", "Александр"];
  const surnames = ["Антошкин-круглов", "Петров", "Иванов", "Смирнов", "Кузнецов", "Попов", "Лебедев", "Козлов", "Новиков", "Морозов"];
